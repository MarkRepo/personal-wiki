...
> 目标：读者看完此页，无需读原书也能把握核心脉络。
> 规则：逐一回答下列问题，有实质内容的留下，无法具体作答的跳过，不强制所有章节都出现。
...
tags: []
last_updated: YYYY-MM-DD
ingest_model: claude-sonnet-4.6   # 执行本次 ingest 的模型
---

## 核心主题
<!-- 书到底讲了什么事 / 探讨什么问题，比"核心问题"更宽，叙事类/描述类书籍同样适用 -->

## 核心观点
<!-- 作者最核心的结论 / 主张 -->

## 核心逻辑
<!-- 全书主线脉络 / 推导逻辑，关键步骤 A→B→C -->

## 知识框架
<!-- 作者构建的概念体系、分类模型、分析结构，有则写，无则跳过 -->

## 核心价值
<!-- 读完能解决什么问题 / 收获什么，读者视角 -->

## 关键记忆点
<!-- 全书最具代表性的内容：可以是数据、案例、金句、反常识结论 -->

## 局限与边界
<!-- 适用范围，作者未覆盖或不适用的场景，有则写，无则跳过 -->
